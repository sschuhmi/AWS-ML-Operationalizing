...
- <ins>1.1 Creation of Jupyter Notebook in Sagemaker Studio<\ins>: The notebook was created using the instance "type ml.t3.medium" (see screenshot), which should be a adequate choice since it provides acceptable performance for many tasks, but reasonably limits costs. In case more power is needed, a change of the instance type to one with more power (e.g., "ml.m5.xlarge") could be the next step.
